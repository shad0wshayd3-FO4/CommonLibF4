...
namespace Scaleform
{
	...
	{
	public:
		static constexpr auto RTTI{ RE::RTTI::Scaleform__SysAllocBase };
		static constexpr auto VTABLE{ RE::VTABLE::Scaleform__SysAllocBase };
	...
	{
	public:
		static constexpr auto RTTI{ RE::RTTI::Scaleform__SysAlloc };
		static constexpr auto VTABLE{ RE::VTABLE::Scaleform__SysAlloc };
