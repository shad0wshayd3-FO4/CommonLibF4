	...
	namespace GFx
	{
		...
		public:
			...
			virtual void GenerateGestureEvents(  // 0F
				...
				[[maybe_unused]] const Render::Point<float>& a_pos,
				[[maybe_unused]] const Render::Point<float>& a_offset,
				[[maybe_unused]] const Render::Point<float>& a_scale,
			...
			virtual void ProcessLoadBinaryMT(  // 26
				[[maybe_unused]] LoadQueueEntry*            a_entry,
